...
func TestReparseMarkup(t *testing.T) {
	test_reparse(t, "abc~def~gh~", ranges.NewRange(5, 6), "+", true)
	test_reparse(t, "~~~~~~~", ranges.NewRange(3, 4), "A", true)
	test_reparse(t, "abc~~", ranges.NewRange(1, 2), "", true)
	...
	test_reparse(t, "#call() abc~d", ranges.NewRange(7, 7), "[]", true)
